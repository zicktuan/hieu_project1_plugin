					...
					array(
						...
						'pages'               => array(
							array(
								...
								'page_title'      => apply_filters('myplugin_option_page_title', __('My Settings', 'bookawesome')),
								'menu_title'      => apply_filters('myplugin_option_menu_title', __('My Settings', 'bookawesome')),
