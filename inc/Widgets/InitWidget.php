...
class InitWidget 
{
	...
	public function includeTemplate() {
		register_widget( 'GMO\Widgets\WidgetFooterAbout' );
		register_widget( 'GMO\Widgets\WidgetFooterText' );
		register_widget( 'GMO\Widgets\WidgetFooterInfo' );
		register_widget( 'GMO\Widgets\WidgetFooterTags' );
	}
