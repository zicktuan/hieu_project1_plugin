...
abstract class AbstractWidget extends \WP_Widget {
	...
	public function locateTemplate( $filename ) {
		...
		$theme_dir = apply_filters( 'gmo_widget_template_theme_dir', 'widgets/' );
		$plugin_path = GMO_PLUGIN_DIR . 'templates/widgets/';
		...
		return apply_filters( 'gmo_widget_locate_template', $path, $filename );
	}
}
